...
public class OdsDocument {
    ...
    @Size(max = 32)
    @Column(name = "date_of_issuance", length = 32)
    ...
    @Size(max = 32)
    @Column(name = "date_of_expiry", length = 32)
    ...
    public OdsDocument(Integer travelerId, String documentType, String countryCode, String docNumber, String surname, String givenName, String citizenship, String dateOfBirth, String personalId, String sex, String placeOfBirth, String dateOfIssuance, String authority, String dateOfExpiry, String docFullId, Integer height, String colorOfEyes, String residence, byte[] picture) {
    ...
    public boolean checkAgeBetween30And50(String dateOfBirth){
